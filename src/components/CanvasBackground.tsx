    ...
    <Float speed={1.5} rotationIntensity={0.8} floatIntensity={2}>
      <group ref={groupRef} position={[15, 0, -25]} scale={[1.2, 1.2, 1.2]}>
        ...
        <mesh position={[0, 0, 1]}>
          ...
          <meshStandardMaterial color="#1a0505" roughness={0.9} metalness={0.1} />
        </mesh>
...
export default function CanvasBackground() {
  return (
    <div className="canvas-bg-wrapper" style={{ position: 'fixed', top: 0, left: 0, width: '100vw', height: '100vh', zIndex: -1, pointerEvents: 'none' }}>
      <Canvas dpr={[1, 2]} gl={{ antialias: false, powerPreference: 'high-performance' }} camera={{ position: [0, 0, 15], fov: 45 }}>
        ...
        {/* Cinematic Red Glare Lights */}
        <pointLight position={[0, 0, -5]} intensity={1500} color="#ff0000" distance={150} />
        <pointLight position={[15, -5, -10]} intensity={2500} color="#ff1100" distance={150} />
        <pointLight position={[-10, 10, -20]} intensity={1000} color="#D0351B" distance={150} />
